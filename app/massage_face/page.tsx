    ...
    <main className={styles.mainContainer}>
      ...
      <section className={styles.hook}>
        ...
        <div className={styles.hookParagraph}>
          ...
          менш помітним. Це зумовлено тим що майстер знімає напругу в м&apos;язах
          обличчя чим покращує обмінні процеси в тканинах, що в свою чергу стимулює вироботку
          колагену та еластану. В результаті підвищується тургор шкіри і ви день
          за днем після процедури спостерігаєте ліфтинг еффект.
        </div>
      ...
      <section className={styles.hook}>
        ...
        <div className={styles.hookParagraph}>
          ...
          здоров&apos;ям і молодістю. Завітайте до нас і
          переконайтеся, що краса може бути не лише естетичною, але й
          комфортною.
        </div>
        <img
          src={
