...
const massageCoursesData: MassageCoursesData[] = [
  {
    courses: [
      {
        ...
        descriptionOptions: [
          'Ручна пластика обличчя (Пропрацювання усіх зон обличчя, зокрема блефаропластичні техніки на підняття верхнього повіка та багато інших)',
    ...
    instructor: {
      ...
      description: ` "Приєднуйтесь до мене, щоб розкрити свій потенціал у
        ...
        разом зі мною."`,
      image: '/photos/masters/master-portfolio-Tatiana_Sklema.jpg',
    },
    feedbacks: [
      {
        name: 'Ірина',
